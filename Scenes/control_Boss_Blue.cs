...
public class control_Boss_Blue : MonoBehaviour
{
        ...
        if (nextShooting <= Time.time)
        {
            if (Bullet_number < Bullet_max)
            {
                if (nextFire <= Time.time)
                {
                    ...
                    // Rotate our transform a step closer to the target's ("Heroi" neste momento).
                    //Spawnar a Bullet com a direcao a apontar para o heroi
